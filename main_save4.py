...
def run_flow(URL, start_page, end_page, parse_func, write_to_db_func):
    ...
    connect_to_page(browser, URL, start_page)
    logger.debug(
...
if __name__ == "__main__":
    ...
    thread_pool(run_flow,
                ...
                pages,
                parse_html_kvartiry_vtorichka,
                write_to_db_kvartiry_vtorichka
                )
    ...
    # 8 threads
    pages = [(1, 5), (6, 11), (12, 17), (18, 25), (26, 31), (32, 37), (38, 43),
             (44, 47)]

    thread_pool(run_flow,
                url_kvartiry_novostroyka,
                pages,
                parse_html_kvartiry_novostroyka,
                write_to_db_kvartiry_novostroyka
                )
    ...
    thread_pool(run_flow,
                ...
                pages,
                parse_html_doma_dachi_kottedzhi,
                write_to_db_doma_dachi_kottedzhi
                )
    ...
    logger.info(
        f'Elapsed run time: {elapsed_time_str} seconds | New vtorichka items: {vtorichka_counter} | New novostroy items: {novostroy_counter} | New doma_dachi_kottedzhi items: {doma_dachi_kottedzhi_counter}')
